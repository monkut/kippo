...
from accounts.models import KippoOrganization, KippoUser, OrganizationMembership, Country
...
class DjangoJsonParser:
    ...
    def __init__(self, jsondump_filepath: Path):
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            default=None,
            required=True,
            help=_('JSON Dump Gzip filepath')
        )
        parser.add_argument(
            '-c', '--country',
            default='JPN',
