# Generated by Django 5.2.1 on 2026-06-11 01:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_type', models.CharField(choices=[('delivery', '納品'), ('monthly', '月額')], default='delivery', help_text="'delivery' (納品, amount billed once at billing_date) or 'monthly' (月額, amount accrues per month).", max_length=20, verbose_name='請求方法')),
                ...
                ('start_date', models.DateField(blank=True, help_text='Contract period start. Defaults to the project start_date when left blank.', null=True, verbose_name='契約開始日')),
                ('end_date', models.DateField(blank=True, help_text='Contract period end. Defaults to the project target_date when left blank.', null=True, verbose_name='契約終了日')),
                ('billing_date', models.DateField(blank=True, help_text="'delivery' only: date the contract amount is billed. Defaults to the project billing_date when left blank.", null=True, verbose_name='請求日')),
