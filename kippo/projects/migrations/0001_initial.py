    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey_issued', models.BooleanField(default=False, help_text='Update when survey is issued!')),
                ('survey_issued_datetime', models.DateTimeField(editable=False, help_text='Updated when "survey_issued" flag is set', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_datetime', models.DateTimeField(auto_now_add=True)),
                ('updated_datetime', models.DateTimeField(auto_now=True)),
                ('label_category_prefixes', models.JSONField(blank=True, default=projects.models.category_prefixes_default, help_text='Github Issue Labels Category Prefixes', null=True)),
                ('label_estimate_prefixes', models.JSONField(blank=True, default=projects.models.estimate_prefixes_default, help_text='Github Issue Labels Estimate Prefixes', null=True)),
                ('organization', models.ForeignKey(blank=True, editable=False, help_text='The organization that the columnset belongs to(if null all project may use it)', null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.KippoOrganization')),
            ],
        ),
        migrations.CreateModel(
