    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_as_active', models.BooleanField(default=True, help_text='If True, project will be included in the ActiveKippoProject List', verbose_name='Display in ActiveKippoProject List')),
        ...
        migrations.AlterUniqueTogether(
            name='projectcolumn',
            unique_together={('column_set', 'name')},
        ),
        migrations.AlterUniqueTogether(
            name='kippomilestone',
