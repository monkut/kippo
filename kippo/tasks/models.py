...
class KippoTask(UserCreatedBaseModel):
    ...
    github_issue_api_url = models.URLField(blank=True, default="")
    github_issue_html_url = models.URLField(blank=True, default="")
    ...
    def latest_kippotaskstatus(self) -> Optional["KippoTaskStatus"]:
        status = None
        with contextlib.suppress(KippoTaskStatus.DoesNotExist):
        ...
        if self.github_issue_html_url:
            ...
            try:
                ...
                existing_repository = GithubRepository.objects.get(
                    ...
                    api_url__startswith=repository_api_url,
                    html_url__startswith=repository_html_url,
                )
...
class KippoTaskStatus(UserCreatedBaseModel):
    ...
    tags = models.JSONField(null=True, blank=True, help_text=_("Any tags/labels related to the current task status"))
